...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hey, I'm Sujeth Lasrado.</p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
          I'm a <span className="heroShiny1 text-fun-pink">Fullstack Java</span>{" "}
          developer who loves{" "}
          <span className="heroShiny2 text-fun-pink">building</span> and{" "}
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <a
            href="/static/resume/Sujeth Lasrado_CV.pdf"
            download="Sujeth Lasrado_Resume.pdf"
            className="cursor-pointer font-bold whitespace-nowrap px-10 py-4 text-fun-pink border-2 text-xl rounded-full border-fun-pink bg-transparent hover:bg-fun-pink hover:text-white transition-colors"
          >
            Download Resume
          </a>
        </div>
